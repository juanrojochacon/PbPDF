...
C *********************************************************
     ...
     1     allvalues(1:31,1:8,0:50,0:50)
      Double precision :: x_i=0.000001, arg(4), fu(4), res, fg(3)
      Double precision :: result(9), dummy
      Double precision :: realQ, Q2min=1.69, 
     1     Q2max=1000000.0, Qsteps=50.0
...
C *********************************************
      ...
      If (pset .LT. 1 .or. pset .GT. psetmax) then
         Write(*,*) 'Wrong set!'
