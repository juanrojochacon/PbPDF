...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[h]
\epsfig{width=0.32\textwidth,figure=nnpdf_logo_official.eps}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-2.0cm}
\begin{flushright}
...
Carlota~A.~Casas$^{1,5}$, Stefano~Carrazza$^{2,3}$, Alberto~Guffanti$^{4}$, 
Nathan~P.~Hartland$^5$, Juan~Rojo$^{5}$, ...... 

\vspace{.3cm}
{\it ~$^1$ Santiago \\
~$^2$  PH Department, TH Unit, CERN,\\ CH-1211 Geneva 23, Switzerland\\
~$^3$ Dipartimento di Fisica, Universit\`a di Milano and
INFN, Sezione di Milano,\\ Via Celoria 16, I-20133 Milano, Italy\\
~$^4$ Niels Bohr International Academy and Discovery Center, \\
Niels Bohr Institute,  University of Copenhagen, \\
Blegdamsvej 17, DK-2100 Copenhagen, Denmark\\
~$^5$ Rudolf Peierls Centre for Theoretical Physics, 1 Keble Road,\\ University of Oxford, OX1 3NP Oxford, UK\\
}
\end{center}   
...
\begin{center}
{\bf \large Abstract}
Nuclear parton distributions of lead nucleai are determined using the
NNPDF methodology.
...
% Compression to Pb data
\input{sec-compression}
